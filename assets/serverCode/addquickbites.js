...
document.getElementById("Btnsubmit").addEventListener("click", function () {
    initializeFormData().then(formData => {
        ...
        .then(function (data) {
            ...
            window.location.href="addQuickBitesList.html";
        })
...
var resdata = JSON.parse(localStorage.getItem('localstore-quick')) || {};
...
async function EditItem(PartitionKey, RowKey) {
    try {
        ...
        localStorage.setItem('localstore-quick', restaurantdata);
        window.location.href = 'AddQuickBites.html';
