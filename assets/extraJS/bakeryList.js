...
//         const categoryTitle = "Bread/Bakery";
...
//             }
//         }
//         /*document.querySelector('#bakeryCount').innerHTML = `(${bakeryCounter})`;*/

//         const itemListElement = document.querySelector('#bakeryItemList');
//         if (itemListElement) {
//             itemListElement.innerHTML = html;
//         } else {
//             throw new Error("#bakeryItemList element not found");
//         }
